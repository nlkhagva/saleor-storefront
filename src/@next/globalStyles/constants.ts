...
export const gray = "7d7d7d7d7d7d";
export const grayMedium = "#c4c4c4";
export const grayDark = "#323232";
export const grayLight = "#F2F3F5";
...
export const blackLight = "rgba(0, 0, 0, 0.25)";
...
export const theme = {
  ...
  listBullet: blackDark,
  overlay: overlayColor,
  primary: black,
  primaryDark: blackDark,
  primaryLight: blackLight,
  primaryTransparent: blackTransparent,
  secondary: blue,
