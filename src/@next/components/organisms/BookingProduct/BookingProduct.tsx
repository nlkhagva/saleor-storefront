...
import { useCart, useCreateSimpleProduct, useProductUpdateMetaData } from '@sdk/react';
...
const BookingProduct: React.FC<IProps> = ({
  ...
  const handleSubmit = async (values: any) => {
    ...
    const _productWarehouse = "V2FyZWhvdXNlOmZkMTI1NjNjLTA3ZTgtNDE4ZS05YzllLTgyYzhkNWJhOGJjNg==";
    ...
    if (product?.data.productCreate.product.id) {
      console.log('product ID: ' + product?.data.productCreate.product.id)
