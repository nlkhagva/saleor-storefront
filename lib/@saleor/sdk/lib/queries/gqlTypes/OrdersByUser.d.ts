...
export interface OrdersByUser_me_orders_edges_node_lines_variant_product_productType {
...
export interface OrdersByUser_me_orders_edges_node_lines_variant_product_thumbnail {
    __typename: "Image";
    /**
...
export interface OrdersByUser_me_orders_edges_node_lines_variant_product_thumbnail2x {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface OrdersByUser_me_orders_edges_node_lines_variant_product {
    ...
    productType: OrdersByUser_me_orders_edges_node_lines_variant_product_productType;
    /**
     * The main thumbnail for a product.
     */
    thumbnail: OrdersByUser_me_orders_edges_node_lines_variant_product_thumbnail | null;
    /**
     * The main thumbnail for a product.
     */
    thumbnail2x: OrdersByUser_me_orders_edges_node_lines_variant_product_thumbnail2x | null;
}
