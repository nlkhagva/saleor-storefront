...
export interface OrderByToken_orderByToken_lines_variant_product_ushop_logoImage {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing | null;
}
export interface OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface OrderByToken_orderByToken_lines_variant_product_ushop {
    __typename: "Ushop";
    /**
     * The ID of the object.
     */
    id: string;
    name: string;
    logoImage: OrderByToken_orderByToken_lines_variant_product_ushop_logoImage | null;
    shippingProduct: OrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct | null;
}
export interface OrderByToken_orderByToken_lines_variant_product {
    ...
    ushop: OrderByToken_orderByToken_lines_variant_product_ushop | null;
}
