...
export interface UserCheckoutDetails_me_checkout_lines_variant_product_metadata {
...
export interface UserCheckoutDetails_me_checkout_lines_variant_product_ushop_logoImage {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing | null;
}
export interface UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface UserCheckoutDetails_me_checkout_lines_variant_product_ushop {
    __typename: "Ushop";
    /**
     * The ID of the object.
     */
    id: string;
    name: string;
    logoImage: UserCheckoutDetails_me_checkout_lines_variant_product_ushop_logoImage | null;
    shippingProduct: UserCheckoutDetails_me_checkout_lines_variant_product_ushop_shippingProduct | null;
}
export interface UserCheckoutDetails_me_checkout_lines_variant_product {
     ...
     */
    metadata: (UserCheckoutDetails_me_checkout_lines_variant_product_metadata | null)[];
    ushop: UserCheckoutDetails_me_checkout_lines_variant_product_ushop | null;
}
