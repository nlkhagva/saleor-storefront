...
export interface UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants_pricing | null;
}
export interface UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface UserOrderByToken_orderByToken_lines_variant_product_ushop {
    ...
    shippingProduct: UserOrderByToken_orderByToken_lines_variant_product_ushop_shippingProduct | null;
}
