...
export interface CheckoutProductVariants_productVariants_edges_node_product_ushop_logoImage {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_variants_pricing | null;
}
export interface CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface CheckoutProductVariants_productVariants_edges_node_product_ushop {
    __typename: "Ushop";
    /**
     * The ID of the object.
     */
    id: string;
    name: string;
    logoImage: CheckoutProductVariants_productVariants_edges_node_product_ushop_logoImage | null;
    shippingProduct: CheckoutProductVariants_productVariants_edges_node_product_ushop_shippingProduct | null;
}
export interface CheckoutProductVariants_productVariants_edges_node_product {
    ...
    ushop: CheckoutProductVariants_productVariants_edges_node_product_ushop | null;
}
