...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_metadata {
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_logoImage {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing | null;
}
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop {
    ...
    id: string;
    name: string;
    logoImage: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_logoImage | null;
    shippingProduct: AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_ushop_shippingProduct | null;
}
export interface AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product {
     ...
     */
    metadata: (AddCheckoutPromoCode_checkoutAddPromoCode_checkout_lines_variant_product_metadata | null)[];
