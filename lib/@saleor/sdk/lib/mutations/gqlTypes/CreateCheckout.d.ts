...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_logoImage {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_variants_pricing | null;
}
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop {
    __typename: "Ushop";
    /**
     * The ID of the object.
     */
    id: string;
    name: string;
    logoImage: CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_logoImage | null;
    shippingProduct: CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop_shippingProduct | null;
}
export interface CreateCheckout_checkoutCreate_checkout_lines_variant_product {
    ...
    ushop: CreateCheckout_checkoutCreate_checkout_lines_variant_product_ushop | null;
}
