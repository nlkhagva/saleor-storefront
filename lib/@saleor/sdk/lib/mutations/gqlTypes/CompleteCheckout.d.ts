...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_metadata {
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_logoImage {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_variants_pricing | null;
}
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop {
    ...
    id: string;
    name: string;
    logoImage: CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_logoImage | null;
    shippingProduct: CompleteCheckout_checkoutComplete_order_lines_variant_product_ushop_shippingProduct | null;
}
export interface CompleteCheckout_checkoutComplete_order_lines_variant_product {
     ...
     */
    metadata: (CompleteCheckout_checkoutComplete_order_lines_variant_product_metadata | null)[];
