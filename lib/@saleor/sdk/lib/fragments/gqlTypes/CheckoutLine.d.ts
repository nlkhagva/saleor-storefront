...
export interface CheckoutLine_variant_product_ushop_logoImage {
    __typename: "Image";
    /**
     * The URL of the image.
     */
...
export interface CheckoutLine_variant_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface CheckoutLine_variant_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface CheckoutLine_variant_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: CheckoutLine_variant_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface CheckoutLine_variant_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: CheckoutLine_variant_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface CheckoutLine_variant_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: CheckoutLine_variant_product_ushop_shippingProduct_variants_pricing | null;
}
export interface CheckoutLine_variant_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: CheckoutLine_variant_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (CheckoutLine_variant_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface CheckoutLine_variant_product_ushop {
    __typename: "Ushop";
    /**
     * The ID of the object.
     */
    id: string;
    name: string;
    logoImage: CheckoutLine_variant_product_ushop_logoImage | null;
    shippingProduct: CheckoutLine_variant_product_ushop_shippingProduct | null;
}
export interface CheckoutLine_variant_product {
    ...
    ushop: CheckoutLine_variant_product_ushop | null;
}
