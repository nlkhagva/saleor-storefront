...
export interface OrderDetail_lines_variant_product_ushop_shippingProduct_productType {
    __typename: "ProductType";
    /**
     * The ID of the object.
     */
...
export interface OrderDetail_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross {
    __typename: "Money";
    /**
     * Amount of money.
     */
...
export interface OrderDetail_lines_variant_product_ushop_shippingProduct_variants_pricing_price {
    __typename: "TaxedMoney";
    /**
     * Amount of money including taxes.
     */
    gross: OrderDetail_lines_variant_product_ushop_shippingProduct_variants_pricing_price_gross;
}
export interface OrderDetail_lines_variant_product_ushop_shippingProduct_variants_pricing {
    __typename: "VariantPricingInfo";
    /**
     * The price, with any discount subtracted.
     */
    price: OrderDetail_lines_variant_product_ushop_shippingProduct_variants_pricing_price | null;
}
export interface OrderDetail_lines_variant_product_ushop_shippingProduct_variants {
     ...
     */
    pricing: OrderDetail_lines_variant_product_ushop_shippingProduct_variants_pricing | null;
}
export interface OrderDetail_lines_variant_product_ushop_shippingProduct {
    __typename: "Product";
    name: string;
    productType: OrderDetail_lines_variant_product_ushop_shippingProduct_productType;
    /**
     * List of variants for the product.
     */
    variants: (OrderDetail_lines_variant_product_ushop_shippingProduct_variants | null)[] | null;
}
export interface OrderDetail_lines_variant_product_ushop {
    ...
    shippingProduct: OrderDetail_lines_variant_product_ushop_shippingProduct | null;
}
